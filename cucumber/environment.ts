 ...
 */
// const DEFAULT_BROWSER = 'chrome:headless';
...
export const METADATA_FILE = process.env.METADATA_FILE || `${DEFAULT_CWD}/cucumber/reports/metadata.json`;
export const SERENITY_REPORT_DIR = process.env.SERENITY_REPORT_DIR || `${DEFAULT_CWD}/cucumber/reports/serenity`;
...
export const TEST_SHOULD_START_APP = process.env.TEST_SHOULD_START_APP === "true";
export const TEST_APP_START_DELAY = process.env.TEST_APP_START_DELAY || "20000";
export const TEST_APP_START_COMMAND = process.env.TEST_APP_START_COMMAND || "npx serve -s build -l 3000";
